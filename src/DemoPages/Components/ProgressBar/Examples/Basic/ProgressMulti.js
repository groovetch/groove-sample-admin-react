  ...
  return (
    <div>
      ...
      <Progress className="mb-3" multi>
        ...
        <Progress bar color="alternate" value="20" />
      ...
      <Progress className="mb-3" multi>
        ...
        <Progress bar color="alternate" value="35">Wow!</Progress>
      ...
      <Progress multi>
        ...
        <Progress bar animated color="alternate" value="30">Animated Stripes</Progress>
