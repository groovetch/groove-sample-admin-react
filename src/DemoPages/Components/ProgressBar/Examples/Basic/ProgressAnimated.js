...
const ProgressAnimatedExample = (props) => {
  return (
    <div>
      ...
      <Progress className="mb-3" animated color="alternate" value="25" />
      ...
      <Progress multi>
        ...
        <Progress animated bar color="alternate" value="30" />
        <Progress animated bar color="warning" value="20" />
        <Progress animated bar color="danger" value="20" />
      </Progress>
        <div className="divider"> </div>
        <Progress className="mb-3 progress-bar-animated-alt" value={2 * 5} />
        <Progress className="mb-3 progress-bar-animated-alt" color="alternate" value="25" />
        ...
        <Progress multi>
            ...
            <Progress className="progress-bar-animated-alt" bar color="alternate" value="30" />
